...
function PlayerSetup({ position, player, index, smallBlind, bigBlind }) {
    return (
        <div className={position[0]} key={index}>
            {index !== 0 ?
                <>
            ...
            <div className="absolute flex flex-col items-center justify-center text-3xl">
                <div className={`font-[Bitter] w-24 h-14 ${player.folded ? 'bg-gray-400' : 'bg-white'} text-black rounded-3xl border-2 border-black flex flex-col justify-center items-center font-bold absolute`}>
