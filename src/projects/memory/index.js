...
function Memory() {
    ...
    return (
        <div className={`flex flex-col items-center h-full ${startDate && 'pt-40'} ${!startDate && 'justify-center'}`}>
            ...
            <button className='text-6xl hover:text-red-700 max-lg:mt-[75%] mt-80'
                onClick={() => {
                    startMemoryGame()
                }} ref={startButtonRef}>
                Start
                        ...
                        <div className="relative my-6 max-w-3xl max-lg:w-full w-1/3">
                            ...
                            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-red-800 outline-none focus:outline-none">
                                ...
                                <div className="relative p-6 flex-auto">
                                    <p className="my-4 text-blueGray-500  max-lg:text-4xl text-2xl leading-relaxed">
                                ...
                                <div className="flex items-center justify-end p-6 border-t border-solid border-blueGray-200 rounded-b">
                                    <button
                                        className="text-red-500 background-transparent font-bold uppercase px-6 py-2  max-lg:text-2xl text-xl outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button"
                                        onClick={() => {
                                            setShowModal(false)
                                    ...
                                    <button
                                        className="bg-emerald-500 text-white active:bg-emerald-600 font-bold uppercase  max-lg:text-2xl text-xl px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
                                        type="button"
                                        onClick={() => {
                                            setShowModal(false)
                                            startMemoryGame()
