...
function TechnologiesCard({ technology }) {
    const MAX_LEVEL = 6
    return (
        <div className="h-[380px] w-[360px] flex justify-evenly flex flex-col items-center text-center p-8 relative font-[CascadiaCode] text-lg gap-4 bg-gradient-to-r  from-neutral-300/25 to-neutral-100/25 rounded-xl">
